...
function Notes() {
    ...
    useEffect(() => {
        const fetchnotes = async () => {
            try {
                ...
                setError('pageComponent fetching notes. Please try again later.');
                setLoading(false);
            }
    ...
    const filterednotes = notes.filter(notes =>
        ...
        notes.category?.toLowerCase().includes(searchQuery.toLowerCase())
    );
            ...
            <div className="lg:p-16 md:p-12">
                ...
                <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table className="lg:w-full md:w-auto text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        <thead>
                        <tr>
                            <th scope="col" className="px-6 py-3">notes Name</th>
