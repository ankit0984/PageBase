...
function Page() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:9595/api/v1/notesdb/upload', formDataToSend, {
                headers: {
    ...
    return (
        <>
            ...
            <div className="container mt-8 p-12">
                <h1 className="mb-14 text-2xl font-semibold font-sans">Upload new notes-collection</h1>
                ...
                {success && <div className="text-green-500 mb-4 text-center">Notes uploaded successfully!</div>}
            </div>
        </>
    )
}
